...
<div id="edit-dialog" class="hidden">
	...
	<form id="volunteer" class="full_width hidden">
		...
		<tr>
			<td><label for="volunteer8"><b>Date Signed-up</b></label></td>						
		</tr>
		<tr>		
			<td>
				<input id="volunteer8" name="signed_up" type="text" size="33"/>
			</td>		
		</tr>
	...
	<form id="grower" class="full_width hidden">
		...
		<div id="statsTable2">
			...
			<span id="toolbar1" class="css_right ui-widget-header ui-corner-all">
				...
				<INPUT type="button" value="AddNewGrower2" onclick="addNewGrower2()" /> 
			</span>
			</div><!-- End toolbar -->
	...
	<form id="tree" class="full_width hidden">
		...
		<tr>
			<td><label for="tree13"><b>Last Harvest Date</b></label></td>			
		</tr>
		<tr>
			<td colspan="7" ><input id="tree13" name="last_date" type="text" size="27"/></td>
		</tr>
